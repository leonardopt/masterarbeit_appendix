...
function cfg = meta_runfile_sim_control_mixedeffectvoxels10
...
cfg.derivative_dir  = fullfile(cfg.all_paths.data_base_dir, 'derivatives_test_sim_control_mixedeffectvoxels10');
cfg.saa.data_gen.batch_version = 'Leo-09-12-20'; % update if needed
