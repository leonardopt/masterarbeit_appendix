...
function fighdl = plot_selected_voxels_afx(position_index,sz,brain_data,mask_index,border_images, fighdl, cfg)
...
try
    if exist('brain_data', 'var') && ~isempty(brain_data)
        ...
        try
            ...
            z = ones(size(x))-.5;
            surface(x,y,z,z_background, 'EdgeColor', 'none');
